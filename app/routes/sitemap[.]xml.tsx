...
export const loader: LoaderFunction = async ({ request }) => {
  ...
  const content = `
          <urlset xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.sitemaps.org/schemas/sitemap/0.9 http://www.sitemaps.org/schemas/sitemap/0.9/sitemap.xsd http://www.w3.org/TR/xhtml11/xhtml11_schema.html http://www.w3.org/2002/08/xhtml/xhtml1-strict.xsd" xmlns="http://www.sitemaps.org/schemas/sitemap/0.9" xmlns:xhtml="http://www.w3.org/TR/xhtml11/xhtml11_schema.html">
            <url>
                <loc>https://facingmyfaces.davidegiovanni.com/it-it</loc>
                <lastmod>2022-01-01T00:00:00+01:00</lastmod>
                <xhtml:link rel="alternate" hreflang="en" href="https://facingmyfaces.davidegiovanni.com/it-it"/>
                <priority>1.0</priority>
            </url>
            <url>
                <loc>https://facingmyfaces.davidegiovanni.com/it.it/faces</loc>
                <lastmod>2022-01-01T00:00:00+01:00</lastmod>
                <xhtml:link rel="alternate" hreflang="it" href="https://facingmyfaces.davidegiovanni.com/it-it/contacts"/>
                <priority>1.0</priority>
            </url>
            <url>
                <loc>https://facingmyfaces.davidegiovanni.com/en-us/about</loc>
                <lastmod>2022-01-01T00:00:00+01:00</lastmod>
                <xhtml:link rel="alternate" hreflang="it" href="https://facingmyfaces.davidegiovanni.com/it-it/about"/>
                <priority>1.0</priority>
            </url>
            ${
              itFeeds.map((feed) =>
                  feed.items.map((item) => `<url>
                  <loc>https://facingmyfaces.davidegiovanni.com/it-it/${feed.title.toLowerCase().split(' ').join('-')}/${getSlug(item.id)}</loc>
